...
@WebServlet(urlPatterns = "/supprimerSaison/")
public class SupprimerSaison extends HttpServlet{
	/**
	...
	protected void doPost(final HttpServletRequest request, final HttpServletResponse response)
		...
		if ((nom != null && !nom.isBlank())&&(numero != null && !numero.isBlank())) {
			try {
				DaoFactory.getInstance().getSaisonDao().deleteSaison(new Saison(nom,Integer.parseInt(numero)),true);
